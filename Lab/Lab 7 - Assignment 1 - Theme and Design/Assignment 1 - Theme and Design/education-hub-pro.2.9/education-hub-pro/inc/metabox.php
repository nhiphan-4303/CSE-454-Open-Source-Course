...
if ( ! function_exists( 'education_hub_render_theme_settings_metabox' ) ) :
	...
	function education_hub_render_theme_settings_metabox() {
		...
		$image_size_options      = education_hub_get_image_sizes_options();
    ...
    <!-- Sidebar option -->
    <?php $sidebar_options = education_hub_get_sidebar_options(); ?>
    <h4 style="font-size:1.2em;"><?php echo __( 'Sidebar Settings', 'education-hub' ); ?></h4>
    <p><strong><?php echo __( 'Primary Location', 'education-hub' ); ?></strong></p>
     <select name="theme_settings[sidebar_location_primary]" id="theme_settings_sidebar_location_primary">
       <option value=""><?php echo __( 'Default', 'education-hub' ); ?></option>
    ...
    <p><strong><?php echo __( 'Secondary Location', 'education-hub' ); ?></strong></p>
