...
if ( ! function_exists( 'education_hub_sanitize_post_id' ) ) :
	 ...
	 * @return int|string Page ID if the page is published; otherwise, the setting default.
	 */
	function education_hub_sanitize_post_id( $post_id, $setting ) {
...
if ( ! function_exists( 'education_hub_sanitize_footer_content' ) ) :
	 ...
	 */
	function education_hub_sanitize_footer_content( $input, $setting ) {
